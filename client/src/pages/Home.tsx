    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <section className="hero-strip" id="visao-geral">
          ...
          <div className="hero-art"><img src="/manus-storage/controle-editorial-sport_88295c8b.png" alt="Ilustração editorial de uma ficha de jogo" /><div className="artifact-overlay"><span>ODD</span><b>2.10</b><span>RETORNO</span><b>R$ 52,50</b><i /></div></div>
        </section>
